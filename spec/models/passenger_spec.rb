...
RSpec.describe Passenger, type: :model do
  ...
  describe "validates passenger name" do
    subject(:booking) do
      create :booking, passengers_attributes: attributes_for(:passenger)
    end
    subject(:passenger) { booking.passenger }

    it { binding.pry; should validate_presence_of :passenger_name }
